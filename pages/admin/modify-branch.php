...
$query = $db->query("SELECT * FROM pl_school_branch_tbl WHERE id = '".$_GET['id']."'");
$row = $query->fetch_object();
$branch = $row->branch;
?>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-pencil"></i> Modify Category</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="#">Maintenance</a></li>
        <li><a href="#">View Branch</a></li>
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <a class="btn btn-primary flat" href="view-branch.php"><i class="fa fa-reply"></i> Back</a>
      </div>
    </div>
    <br>
    <div class="row">
        ...
        <!-- general form elements -->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-exclamation-circle"></i> Category</h3>
            </div>
            <!-- /.box-header -->
            <?php modify_branch()?>
            <!-- form start -->
            <form role="form" method="POST" data-parsley-validate>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"  value="<?php echo $branch ?>" name="branch" required>
                </div>

              <!-- /.box-body -->
              <div class="box-footer">
                <button type="submit" name="btn-edit-branch" class="btn btn-primary flat"><i class="fa fa-check-circle"> Save Changes</i></button>
                <button type="submit" name="btn-delete-branch" class="btn btn-danger flat"><i class="fa fa-trash"> Delete Branch</i></button>
              </div>
            </form>
          </div>
          <!-- /.box -->
