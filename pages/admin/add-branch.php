        ...
        <!-- general form elements -->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-plus-circle"></i> Create New Branch</h3>
            </div>
            <!-- /.box-header -->
            <?php add_branch()?>
            <!-- form start -->
            <form role="form" method="POST" data-parsley-validate>
              ...
              <div class="box-footer">
                <button type="submit" name="btn-add-branch" class="btn btn-primary flat"><i class="fa fa-plus-circle"> Add Branch</i></button>
              </div>
            </form>
          </div>
          <!-- /.box -->
