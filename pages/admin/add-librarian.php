...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-user-plus"></i> Add Librarian</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="#">Manage Account</a></li>
        <li class="active"><a href="#">Add Librarian</a></li>
      </ol>
    </section>
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <a class="btn btn-primary flat" href="view-librarian-account.php"><i class="fa fa-reply"></i> Back</a>
      </div>
    </div>
    <br>
    <div class="row">
        ...
        <!-- general form elements -->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-exclamation-circle"></i> Librarian Information</h3>
            </div>
            <!-- /.box-header -->
            <?php add()?>
            <!-- form start -->
            <form role="form" method="POST" data-parsley-validate>
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="StudentID">Librarian ID</label>
                  <input type="hidden" class="form-control"  name="level" value=0 required>
              ...
              <div class="box-footer">
                <button type="submit" name="btn-add" class="btn btn-primary flat"><i class="fa fa-user-plus"> Add Librarian</i></button>
              </div>
            </form>
          </div>
          <!-- /.box -->
