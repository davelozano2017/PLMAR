...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-eye"></i> View Category</h1>
      <ol class="breadcrumb">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <a href="add-book-category.php" class="btn btn-primary flat"><i class="fa fa-plus-circle"></i> Add Book Category</a>
      </div>
    </div>
    <br>
    <div class="row">
        ...
        <!-- general form elements -->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-book"></i> List of Categories</h3>
            </div>
            <!-- /.box-header -->
              <div class="box-body">
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                         ...
                         <?php 
                            global $db;
                            $sql = "SELECT * FROM pl_books_category_tbl";
                            $i = 1;
                            $query = $db->query($sql);
                            ...
                            while ($row = $query->fetch_object()) {
                              ...
                              <td>'.$row->category.'</td>
                              <td>
                              <a href="modify-category.php?id='.$row->id.'" 
